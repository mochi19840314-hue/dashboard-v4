...
assert.match(html,/style\.css\?v=1059/);assert.match(html,/report-month\.js\?v=1061/);assert.match(html,/app\.js\?v=1062/);
assert.match(sw,/keita-dashboard-v1062-daily-shadow-brief/);assert.match(sw,/style\.css\?v=1059/);assert.match(sw,/report-month\.js\?v=1061/);assert.match(sw,/app\.js\?v=1062/);
