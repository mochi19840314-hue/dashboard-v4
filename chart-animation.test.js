...
assert.match(html,/style\.css\?v=1057/);assert.match(html,/app\.js\?v=1057/);
assert.match(sw,/keita-dashboard-v1057-chart-scroll-animation/);assert.match(sw,/style\.css\?v=1057/);assert.match(sw,/app\.js\?v=1057/);
