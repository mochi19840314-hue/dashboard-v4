...
assert.match(html,/style\.css\?v=9405/);assert.match(html,/report-month\.js\?v=1061/);assert.match(html,/app\.js\?v=9405/);
assert.match(sw,/keita-dashboard-v9405-cash-flow-minimum/);assert.match(sw,/style\.css\?v=9405/);assert.match(sw,/report-month\.js\?v=1061/);assert.match(sw,/app\.js\?v=9405/);
