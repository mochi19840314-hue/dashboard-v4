...
assert.match(html,/style\.css\?v=1070/);assert.match(html,/report-month\.js\?v=1061/);assert.match(html,/app\.js\?v=1070/);
assert.match(sw,/keita-dashboard-v1070-shadow-intelligence/);assert.match(sw,/style\.css\?v=1070/);assert.match(sw,/report-month\.js\?v=1061/);assert.match(sw,/app\.js\?v=1070/);
