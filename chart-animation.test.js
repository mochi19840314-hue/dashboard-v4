...
assert.match(html,/style\.css\?v=1084/);assert.match(html,/report-month\.js\?v=1061/);assert.match(html,/app\.js\?v=1087/);
assert.match(sw,/keita-dashboard-v1087-morning-proposals/);assert.match(sw,/style\.css\?v=1084/);assert.match(sw,/report-month\.js\?v=1061/);assert.match(sw,/app\.js\?v=1087/);
