...
assert.match(sw,/keita-dashboard-v9401-today-entry/);assert.match(sw,/style\.css\?v=9401/);assert.match(sw,/report-month\.js\?v=1061/);assert.match(sw,/app\.js\?v=9401/);
