...
assert.match(sw,/keita-dashboard-v1077-clinical-efficiency/);assert.match(sw,/style\.css\?v=1077/);assert.match(sw,/report-month\.js\?v=1061/);assert.match(sw,/app\.js\?v=1077/);
