...
assert.match(html,/style\.css\?v=1073/);assert.match(html,/report-month\.js\?v=1061/);assert.match(html,/app\.js\?v=1073/);
assert.match(sw,/keita-dashboard-v1073-shadow-actions/);assert.match(sw,/style\.css\?v=1073/);assert.match(sw,/report-month\.js\?v=1061/);assert.match(sw,/app\.js\?v=1073/);
