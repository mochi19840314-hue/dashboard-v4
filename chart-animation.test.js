...
assert.match(html,/style\.css\?v=9406/);assert.match(html,/report-month\.js\?v=1061/);assert.match(html,/app\.js\?v=9406/);
assert.match(sw,/keita-dashboard-v9406-finance-simple/);assert.match(sw,/style\.css\?v=9406/);assert.match(sw,/report-month\.js\?v=1061/);assert.match(sw,/app\.js\?v=9406/);
