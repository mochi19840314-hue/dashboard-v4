...
{
 const data={entries:[{date:"2026-09-01",sales:1000000},{date:"2026-09-02",sales:500000}],financeByMonth:{"2026-09":{morikuboOnline:100000,royalCanin:50000,purina:0,medicalExpense:330000,entered:{medicalExpense:true}}}};
 const r=GrossProfitKpi.summarize(data,"2026-09");
 assert.equal(r.sales,1650000);assert.equal(r.directMedicalCost,330000);assert.equal(r.grossProfit,1320000);assert.equal(r.grossMargin,80);
}
{
