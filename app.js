...
function render(){
 const sections=[recent,month,renderMonthlyReport,renderStrategyIntelligence,renderClinicalIntelligence,renderClinicalTrends,years,year,finance,renderClinicSettings,renderBusinessSimulator,storage,renderTodaySummary,renderDailyShadowBrief,renderTodayStrategy,renderSeasonForecast,renderLearningInsight,renderWeeklyInsights,renderSuccessLibrary,renderBusinessAnomalies,renderDailyReview,renderKagemusha,renderKagemushaDiary,renderPhase1Director,renderManagementInsight];
