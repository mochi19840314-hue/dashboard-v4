...
function render(){
 const sections=[recent,month,renderMonthlyReport,renderClinicalIntelligence,renderClinicalTrends,years,year,finance,renderClinicSettings,storage,renderTodaySummary,renderDailyShadowBrief,renderTodayMission,renderBusinessAnomalies,renderDailyAI,renderKagemusha,renderKagemushaDiary,renderPhase1Director,renderManagementInsight];
