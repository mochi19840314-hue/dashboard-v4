...
function recentActivityRows(){return RecentActivity.rows(data.entries,{closedDates:data.clinic?.closedDates,healthHistory:data.businessHealthHistory})}
