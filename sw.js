const C="keita-dashboard-v1040-ai-advisor";
const A=["./","./index.html","./style.css?v=1040","./app.js?v=1040","./ai-director.js?v=1021","./manifest.json","./icon-192.png","./icon-512.png","./clinic-logo.png"];
