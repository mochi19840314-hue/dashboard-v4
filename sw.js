const C="keita-dashboard-v1049-kagemusha-images";
const A=["./","./index.html","./style.css?v=1047","./app.js?v=1049","./ai-director.js?v=1046","./manifest.json","./icon-192.png","./icon-512.png","./clinic-logo.png","./kagemusha-normal.jpeg","./kagemusha-smile.jpeg","./影武者思考.jpeg","./kagemusha-warning.jpeg"];
