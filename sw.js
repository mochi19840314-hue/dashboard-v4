const C="keita-dashboard-v1045-kagemusha-diary";
const A=["./","./index.html","./style.css?v=1045","./app.js?v=1045","./ai-director.js?v=1045","./manifest.json","./icon-192.png","./icon-512.png","./clinic-logo.png"];
