const C="keita-dashboard-v1046-kagemusha-image-fallback";
const A=["./","./index.html","./style.css?v=1046","./app.js?v=1046","./ai-director.js?v=1046","./manifest.json","./icon-192.png","./icon-512.png","./clinic-logo.png"];
