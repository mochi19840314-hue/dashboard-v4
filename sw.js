const C="keita-dashboard-v1047-monthly-kagemusha";
const A=["./","./index.html","./style.css?v=1047","./app.js?v=1047","./ai-director.js?v=1046","./manifest.json","./icon-192.png","./icon-512.png","./clinic-logo.png"];
