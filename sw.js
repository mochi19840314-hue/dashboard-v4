const C="keita-dashboard-v1021-memo-ai";
const A=["./","./index.html","./style.css?v=1021","./app.js?v=1021","./ai-director.js?v=1021","./manifest.json","./icon-192.png","./icon-512.png","./clinic-logo.png"];
