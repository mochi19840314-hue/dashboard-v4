const C="keita-dashboard-v1022-management-insight";
const A=["./","./index.html","./style.css?v=1022","./app.js?v=1022","./ai-director.js?v=1021","./manifest.json","./icon-192.png","./icon-512.png","./clinic-logo.png"];
