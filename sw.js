const C="keita-dashboard-v1041-annual-detail";
const A=["./","./index.html","./style.css?v=1041","./app.js?v=1041","./ai-director.js?v=1021","./manifest.json","./icon-192.png","./icon-512.png","./clinic-logo.png"];
