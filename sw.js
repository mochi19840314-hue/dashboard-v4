const C="keita-dashboard-v1042-kagemusha";
const A=["./","./index.html","./style.css?v=1042","./app.js?v=1042","./ai-director.js?v=1021","./manifest.json","./icon-192.png","./icon-512.png","./clinic-logo.png"];
