const C="keita-dashboard-v1011-ai-director-prevday";
const A=["./","./index.html","./style.css?v=1004","./app.js?v=1004","./ai-director.js?v=1011","./manifest.json","./icon-192.png","./icon-512.png","./clinic-logo.png"];
