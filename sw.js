const C="keita-dashboard-v1013-morning-briefing";
const A=["./","./index.html","./style.css?v=1004","./app.js?v=1004","./ai-director.js?v=1013","./manifest.json","./icon-192.png","./icon-512.png","./clinic-logo.png"];
