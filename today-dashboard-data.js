...
// v10.2.3: sequential, cache-busted bootstrap. No observers or background AI calls.
if(typeof document!=="undefined"&&typeof window!=="undefined"){
 ...
 load("./today-one-action.js?v=1021",()=>load("./kagemusha-intelligence.js?v=1022",()=>load("./today-one-action-ui.js?v=1021",()=>load("./evaluation-role-ui.js?v=1022",()=>load("./today-clinical-brief.js?v=1")))));
}
