...
assert.match(html,/app\.js\?v=9300/);assert.match(html,/style\.css\?v=9300/);
assert.match(sw,/keita-dashboard-v9300-daily-memo-learning/);assert.match(sw,/app\.js\?v=9300/);assert.match(sw,/style\.css\?v=9300/);
