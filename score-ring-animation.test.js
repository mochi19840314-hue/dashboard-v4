...
assert.match(html,/app\.js\?v=9000/);assert.match(html,/style\.css\?v=9000/);
assert.match(sw,/keita-dashboard-v9000-today-renewal/);assert.match(sw,/app\.js\?v=9000/);assert.match(sw,/style\.css\?v=9000/);
