...
assert.match(html,/app\.js\?v=9402/);assert.match(html,/style\.css\?v=9402/);
assert.match(sw,/keita-dashboard-v9402-past-entry-edit/);assert.match(sw,/app\.js\?v=9402/);assert.match(sw,/style\.css\?v=9402/);
