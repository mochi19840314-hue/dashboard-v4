...
assert.match(html,/app\.js\?v=7000/);assert.match(html,/style\.css\?v=7000/);
assert.match(sw,/keita-dashboard-v7000-clinical-learning-engine/);assert.match(sw,/app\.js\?v=7000/);assert.match(sw,/style\.css\?v=7000/);
