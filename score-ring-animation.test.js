...
assert.match(html,/app\.js\?v=1058/);assert.match(html,/style\.css\?v=1058/);
assert.match(sw,/keita-dashboard-v1058-score-ring-scroll-animation/);assert.match(sw,/app\.js\?v=1058/);assert.match(sw,/style\.css\?v=1058/);
