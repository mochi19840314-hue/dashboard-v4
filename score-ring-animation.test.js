...
assert.match(html,/app\.js\?v=1060/);assert.match(html,/style\.css\?v=1059/);
assert.match(sw,/keita-dashboard-v1060-date-ranges/);assert.match(sw,/app\.js\?v=1060/);assert.match(sw,/style\.css\?v=1059/);
