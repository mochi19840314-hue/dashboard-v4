...
assert.match(html,/app\.js\?v=9401/);assert.match(html,/style\.css\?v=9401/);
assert.match(sw,/keita-dashboard-v9401-clinical-learning/);assert.match(sw,/app\.js\?v=9401/);assert.match(sw,/style\.css\?v=9401/);
