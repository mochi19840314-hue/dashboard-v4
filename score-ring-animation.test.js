...
assert.match(html,/app\.js\?v=9506/);assert.match(html,/style\.css\?v=9506/);
assert.match(sw,/keita-dashboard-v9506-remove-legacy-entry-dom/);assert.match(sw,/app\.js\?v=9506/);assert.match(sw,/style\.css\?v=9506/);
