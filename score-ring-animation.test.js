...
assert.match(html,/app\.js\?v=9100/);assert.match(html,/style\.css\?v=9100/);
assert.match(sw,/keita-dashboard-v9100-today-entry/);assert.match(sw,/app\.js\?v=9100/);assert.match(sw,/style\.css\?v=9100/);
