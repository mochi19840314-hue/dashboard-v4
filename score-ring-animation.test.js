...
assert.match(html,/app\.js\?v=1088/);assert.match(html,/style\.css\?v=1088/);
assert.match(sw,/keita-dashboard-v1088-unified-today-strategy/);assert.match(sw,/app\.js\?v=1088/);assert.match(sw,/style\.css\?v=1088/);
