...
assert.match(html,/app\.js\?v=1072/);assert.match(html,/style\.css\?v=1072/);
assert.match(sw,/keita-dashboard-v1072-clinical-canonical/);assert.match(sw,/app\.js\?v=1072/);assert.match(sw,/style\.css\?v=1072/);
