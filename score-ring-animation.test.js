...
assert.match(html,/app\.js\?v=9201/);assert.match(html,/style\.css\?v=9201/);
assert.match(sw,/keita-dashboard-v9201-recent-activity-scroll/);assert.match(sw,/app\.js\?v=9201/);assert.match(sw,/style\.css\?v=9201/);
