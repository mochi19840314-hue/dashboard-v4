...
assert.match(html,/app\.js\?v=1087/);assert.match(html,/style\.css\?v=1084/);
assert.match(sw,/keita-dashboard-v1087-morning-proposals/);assert.match(sw,/app\.js\?v=1087/);assert.match(sw,/style\.css\?v=1084/);
