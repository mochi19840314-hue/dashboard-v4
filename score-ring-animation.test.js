...
assert.match(html,/app\.js\?v=6002/);assert.match(html,/style\.css\?v=1088/);
assert.match(sw,/keita-dashboard-v6002-stable-annual-profit/);assert.match(sw,/app\.js\?v=6002/);assert.match(sw,/style\.css\?v=1088/);
