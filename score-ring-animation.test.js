...
assert.match(html,/app\.js\?v=1071/);assert.match(html,/style\.css\?v=1071/);
assert.match(sw,/keita-dashboard-v1071-clinical-input/);assert.match(sw,/app\.js\?v=1071/);assert.match(sw,/style\.css\?v=1071/);
