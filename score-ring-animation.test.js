...
assert.match(html,/app\.js\?v=1076/);assert.match(html,/style\.css\?v=1076/);
assert.match(sw,/keita-dashboard-v1076-clinical-intelligence/);assert.match(sw,/app\.js\?v=1076/);assert.match(sw,/style\.css\?v=1076/);
