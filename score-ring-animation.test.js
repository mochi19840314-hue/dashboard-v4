...
assert.match(html,/app\.js\?v=9404/);assert.match(html,/style\.css\?v=9402/);
assert.match(sw,/keita-dashboard-v9404-clinical-steppers/);assert.match(sw,/app\.js\?v=9404/);assert.match(sw,/style\.css\?v=9402/);
