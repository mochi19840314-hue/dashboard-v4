...
assert.match(html,/app\.js\?v=1059/);assert.match(html,/style\.css\?v=1059/);
assert.match(sw,/keita-dashboard-v1059-month-rollover/);assert.match(sw,/app\.js\?v=1059/);assert.match(sw,/style\.css\?v=1059/);
