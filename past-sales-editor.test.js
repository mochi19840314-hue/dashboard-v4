...
test("past sales editor is loaded by the lightweight bootstrap",()=>{assert.match(bootstrap,/past-sales-editor\.js\?v=1032/);assert.doesNotMatch(ui,/MutationObserver/)});
