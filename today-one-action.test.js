...
assert.match(bootstrap,/today-one-action\.js\?v=1012/);
assert.match(bootstrap,/today-one-action-ui\.js\?v=1012/);
const sw=fs.readFileSync("sw.js","utf8");
assert.match(sw,/\.\/today-one-action\.js\?v=1012/);
assert.match(sw,/\.\/today-one-action-ui\.js\?v=1012/);
console.log("Today One Action / Kagemusha: 13 scenarios passed");
