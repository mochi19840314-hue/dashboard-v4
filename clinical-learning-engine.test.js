const test=require("node:test"),assert=require("node:assert/strict"),Engine=require("./clinical-learning-engine.js");
const entry=(date,overrides={})=>({date,patients:20,newPatients:4,sales:240000,expense:120000,checkups:4,clinical:{bloodTests:8,xrays:4,ultrasounds:2,revisits:16},...overrides});
