(function(root,factory){
  ...
  function normalizeBackup(raw,defaults,storageKey){
    ...
    const data={...definedObject(defaults),...definedObject(source),entries,learningHistory:Array.isArray(source.learningHistory)?source.learningHistory:[],weeklyLearningHistory:Array.isArray(source.weeklyLearningHistory)?source.weeklyLearningHistory:[],finance:{...financeDefaults,...definedObject(source.finance)},financeByMonth,monthlyReports:{...definedObject(defaults.monthlyReports),...definedObject(source.monthlyReports)},clinic,weatherCache:source.weatherCache===undefined?defaults.weatherCache:source.weatherCache,historical:{...definedObject(defaults.historical),...definedObject(source.historical)},settings:{...definedObject(defaults.settings),...definedObject(source.settings)},memo:source.memo===undefined?defaults.memo:source.memo};
