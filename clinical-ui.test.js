...
assert.match(sw,/v9402-past-entry-edit/);assert.match(sw,/app\.js\?v=9402/);assert.match(html,/app\.js\?v=9402/);assert.match(html,/AI MANAGEMENT INSIGHTS/);assert.match(html,/診療データが蓄積されると/);assert.match(app,/management-insight/);
