...
assert.match(sw,/v6002/);assert.match(sw,/app\.js\?v=6002/);assert.match(html,/app\.js\?v=6002/);assert.match(html,/AI MANAGEMENT INSIGHTS/);assert.match(html,/診療データが蓄積されると/);assert.match(app,/management-insight/);
