...
assert.match(sw,/v1087/);assert.match(sw,/app\.js\?v=1087/);assert.match(html,/app\.js\?v=1087/);assert.match(html,/AI MANAGEMENT INSIGHTS/);assert.match(html,/診療データが蓄積されると/);assert.match(app,/management-insight/);
