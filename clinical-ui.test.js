...
assert.match(sw,/v9406-finance-simple/);assert.match(sw,/app\.js\?v=9406/);assert.match(html,/app\.js\?v=9406/);assert.match(html,/AI MANAGEMENT INSIGHTS/);assert.match(html,/診療データが蓄積されると/);assert.match(app,/management-insight/);
