...
assert.match(sw,/v7000/);assert.match(sw,/app\.js\?v=7000/);assert.match(html,/app\.js\?v=7000/);assert.match(html,/AI MANAGEMENT INSIGHTS/);assert.match(html,/診療データが蓄積されると/);assert.match(app,/management-insight/);
